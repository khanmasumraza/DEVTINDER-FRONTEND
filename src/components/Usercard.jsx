...
const Usercard = ({ user }) => {
  ...
  return (
    <div
      className="
        relative 
        w-72 sm:w-80 md:w-88     /* smaller width for mobile */
        h-[480px] sm:h-[520px] md:h-[550px]
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute bottom-20 left-10 text-pink-300/20 animate-bounce"
          style={{ animationDelay: '0s', animationDuration: '3s' }}
        >
          ❤️
        </div>
        <div
          className="absolute bottom-32 right-16 text-red-300/20 animate-bounce"
          style={{ animationDelay: '1s', animationDuration: '4s' }}
        >
          💕
        </div>
        <div
          className="absolute bottom-40 left-20 text-pink-400/20 animate-bounce"
